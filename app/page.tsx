...
import SupercellCarousel from "@/components/supercell-carousel"
        ...
        <div className="flex h-full relative">
                  ...
                  <div className="bg-white/20 dark:bg-black/20 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-800 dark:text-gray-200 truncate ml-2">{user.email}</span>
                      </div>
                      <div className="flex justify-between">
          ...
          <main className="flex-1 p-4 md:p-6 overflow-y-auto h-full">
            {activeSection === "community" ? (
              ...
              <>
                {/* Featured Game */}
                <div className="relative rounded-2xl overflow-hidden mb-8 bg-black/20 backdrop-blur-sm">
                  ...
                  <div className="relative p-6 md:p-8">
                    <div className="bg-black/20 backdrop-blur-sm inline-block px-3 py-1 rounded-full text-white text-sm mb-4">
                      Em Alta
                    </div>

                    <h1 className="text-2xl md:text-4xl font-bold mb-2 text-white">{featuredGame.title}</h1>

                    <div className="flex items-center space-x-3 text-white/80 text-sm mb-4">
                      {/* <span>{featuredGame.year}</span>
                      <span>•</span>
                      <span>{featuredGame.duration}</span>
                      <span>•</span>
                      <span>{featuredGame.languages}</span> */}
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                      <Link href={`/valorant`}>
                      <Button className="btn-blue rounded-full px-6">
                      ...
                      <WishlistButton
                        ...
                        className="border-white/30 text-white hover:bg-white/20 bg-transparent rounded-full"
                      />
                    </div>
                  </div>
                </div>
